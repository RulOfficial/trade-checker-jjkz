...
A simple and fast tool to compare item values and make fair trades in Jujutsu: Zero (Roblox Game).

Compare two sets of items side-by-side, calculate total values, and see the difference percentage to ensure balanced trades.
...
Items are loaded from `data.csv` with columns:
...
Feel free to submit updates to the item catalog or suggest new features.
